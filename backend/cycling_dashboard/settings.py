...
ROOT_URLCONF = 'cycling_dashboard.urls'
...
WSGI_APPLICATION = 'cycling_dashboard.wsgi.application'
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('POSTGRES_DB', 'cycling_dashboard'),
...
# Celery (use REDIS_URL from Railway, fallback to explicit URLs)
REDIS_URL = os.getenv('REDIS_URL')
CELERY_BROKER_URL = REDIS_URL or os.getenv('CELERY_BROKER_URL', 'redis://localhost:6379/0')
CELERY_RESULT_BACKEND = REDIS_URL or os.getenv('CELERY_RESULT_BACKEND', 'redis://localhost:6379/0')
