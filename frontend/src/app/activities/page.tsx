                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0 py-4 pr-2">
                          <p className="font-display font-semibold text-slate-200 group-hover:text-white transition-colors truncate text-sm">
                            {activity.name}
                          </p>
                          <span
                            className="inline-flex items-center mt-1 text-[10px] font-medium tracking-wide"
                            style={{ color: indoor ? 'rgba(34,211,238,0.6)' : 'rgba(251,146,60,0.6)' }}
                          >
                        ...
                        <div className="hidden sm:flex items-center gap-6 py-4 pr-5">
                          ...
                          {activity.average_watts && (
                            <StatCol label="power" value={formatPower(activity.average_watts)} />
                          )}
                          {activity.average_heartrate && !activity.average_watts && (
                            <StatCol label="hr" value={`${Math.round(activity.average_heartrate)}bpm`} />
                          )}
                        </div>

                        {/* Mobile compact */}
                        <div className="flex sm:hidden flex-col items-end justify-center py-4 pr-4 gap-0.5">
                          <p className="font-bebas text-xl leading-none" style={{ color: accent }}>
  ...
  return (
    <div className="text-right min-w-[52px]">
      <p
        ...
        style={{ color: color ?? 'rgba(148,163,184,0.7)' }}
      >
        {value}
      </p>
